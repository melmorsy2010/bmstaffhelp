...
class tahod2 extends StatefulWidget {
  @override
  _tahod2State createState() => _tahod2State();
}

class _tahod2State extends State<tahod2> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "جهات متعاقده \n تعهد جهه العمل بتحويل الراتب او القسط دون المستحقات بالعاملين بالدوله ( تحويل راتب بالكامل )",textAlign: TextAlign.center,
