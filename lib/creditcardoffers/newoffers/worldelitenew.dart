...
Future<void> generateAndPrintArabicPdf5({String details,String bookNum,String replay,String date,String subject,List<String>items, List<String> itemss, List<String> itemsss, List<String> itemsss4, List<String> itemsss5,List<String> itemsss6, List<String> itemsss7, List<String> itemsss8, String details2, String details3, List<String> itemsss9,}) async {
  ...
  final profileImage = MemoryImage(
    (await rootBundle.load('assets/w.jpg')).buffer.asUint8List(),
  );
                      ...
                      Row(
                          ...
                          children: [
                            Directionality(
                                textDirection: TextDirection.rtl,
                                child: Center(
                                    child: Text('ماستر كارد وورلد ايليت', style: TextStyle(
                                        fontSize: 17
                                    ))
                                )
                            ),
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('دخول مجاني غير محدود لأكثر من 900 صالة لاونج كي في جميع انحاء العالم للمزيد من \nالمعلومات عن صالات كبار الزوار بمختلف المطارات يرجي زياره   www.loungekey.com/mcworld  ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('توفر المنظمة الدولية مركز دعم فني متخصص علي مدار 24 ساعة يوميا لتقديم العديد من \nالخدمات لحاملي البطاقة (Cardholder enquiries) بالإضافة إلي ما يقدمه مركز الاتصال الخاص \nببنك مصر 19888 من خدمات', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('توفر المنظمة خدمة تأمينية عند السفر مثل ضياع الحقائب – تأخر وصول الحقائب\n – إلغاء الرحلة – التأمين الطبي أثناء السفر ... إلخ.', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('  واحد جنيه =   نقطة  3.5', style: TextStyle(
                                    fontSize: 17
                                ))
                            )
                        ),
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('  واحد جنيه =   نقطة  4', style: TextStyle(
                                    fontSize: 17
                                ))
                            )
                        ),
                              ...
                              Column(
                                  ...
                                  children: [
                                    pw.Align(
                                        alignment: pw.Alignment.topLeft,
                                        child: pw.UrlLink(
                                            destination: 'https://www.mastercard.com.sa/ar-sa/consumers/find-card-products/world.html',
                                            child:
                                            Container(
                                              // width: 100,
                                              height: 130,
 ...
 // await Printing.layoutPdf(onLayout: (PdfPageFormat format) async => pdf.save());
  await Printing.sharePdf(bytes: await pdf.save(), filename: 'World Elite.pdf');
