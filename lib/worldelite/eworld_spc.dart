...
class EworldDesc extends StatelessWidget {
  @override
          ...
          children: [
            ...
            TableRow(children: [
              ...
              Padding(
                ...
                child: Text(' فى حدود الحد الائتمانى للبطاقه وبحد اقصى 800000جم شهريا وبحد اقصى 8 مرات يوميا',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black,fontSize: 13,fontWeight: FontWeight.bold),),
              ),
            ]),
            TableRow(children: [
              Padding(
              ...
              Padding(
                padding: const EdgeInsets.all(2.0),
                child: Text(' فى حدود الحد الائتمانى للبطاقه وبحد اقصى 800000جم شهريا وبحد اقصى 5 مرات يوميا',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black,fontSize: 13,fontWeight: FontWeight.bold),),
              ),
            ]),
