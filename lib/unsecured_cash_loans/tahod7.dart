...
class tahod7 extends StatefulWidget {
  @override
  _tahod7State createState() => _tahod7State();
}

class _tahod7State extends State<tahod7> {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 0,),
                          child: Container(
                            child: Center(child: Text(" 14.00",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3864",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "سند لامر + تفويض بملئ السند لامر",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
