...
class Wekalaemployee extends StatefulWidget {
  @override
  _WekalaemployeeState createState() => _WekalaemployeeState();
}

class _WekalaemployeeState extends State<Wekalaemployee>
                          ...
                          children: <Widget>[
                            ...
                            AnimatedOpacity(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Container(
                                      child: Center(child: Text("الموظفين بتعهد جهه العمل",style: GoogleFonts.cairo(color: Colors.white,fontSize: 13,fontWeight: FontWeight.bold,),textAlign: TextAlign.center,)),
                                      height: 50,
                                      width: 250,
                                      decoration: BoxDecoration(
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  child: Center(child: Text(" (ق ع ) 96 شهر  ( ق خ ) 60 شهر",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13 ),textDirection: TextDirection.rtl)),
                                  width: 94,
                                  height: 50,
                                  decoration: BoxDecoration(
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0),
                                child: Container(
                                  child: Center(child: Text(" 500000 للقطاع الخاص \n للقطاع العام 1000000",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 9 ),textAlign: TextAlign.right,)),
                                  width: 94,
                                  height: 60,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(0),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right: 0,),
                                child: Container(
                                  child: Center(child: Text(" 14.50",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                                  width: 94,
                                  height: 60,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(0),
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0),
                                child: Container(
                                  child: Center(child: Text("3025 قطاع عام \n 3026 قطاع خاص",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13 ),textDirection: TextDirection.rtl)),
                                  width: 94,
                                  height: 60,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(0),
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "سند لأمر + تفويض بملئ السند ( للقطاع الاعمال والجهات الحكوميه) ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "شيكات سنوية مسطرة ومؤرخة + شيك مسطر بإجمالي قيمة االقساط المستحقة ( لموظفي القطاع الخاص ) ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
