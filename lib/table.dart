...
class _TablePageState extends State<TablePage> {
  ...
  String tableAppBarTitle = "تفاصيل القرض";
  String creditAmountText = "مبلغ القرض";
  String installmentText = "القسط الشهرى";
  String creditTermText = "مده القرض";
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  child: Center(child: Text("القرض المطلوب",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13,color: Colors.white ),)),
                                  width: 200,
                                  height: 30,
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right: 10),
                                child: Container(
                                  child: Center(child: Text("مده القرض",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13,color: Colors.white ),)),
                                  width: 200,
                                  height: 30,
                                  decoration: BoxDecoration(
                                    color: Colors.black,
    ...
    return DataTable(
      ...
      rows: widget.creditTableList
        ...
        DataCell(
          Center(
            child: Text(
                (widget.creditTableList.indexOf(dataRow) + 1).toString(),style: TextStyle(color: Colors.black,),),
          ),
          showEditIcon: false,
          placeholder: false,
        ),
