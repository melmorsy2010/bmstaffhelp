...
class tahod2durabel extends StatefulWidget {


  @override

  _tahod2durabelState createState() => _tahod2durabelState();
}

class _tahod2durabelState extends State<tahod2durabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "تعهد جهة العمل بتحويل المرتب أو القسط ق.ع بدون تعهد تحويل المستحقات",textAlign: TextAlign.center,
