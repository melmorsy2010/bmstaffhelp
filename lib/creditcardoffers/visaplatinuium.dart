            ...
            child: canShow ?Column(children: [
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Text(
                        "حماية المشتريات: حيث تقدم تلك الخدمة لحاملي البطاقات البلاتينية لحماية مشترياتهم ضد السرقة والتلف لمدة 365 يوم من تاريخ الشراء.",
                        textDirection: TextDirection.rtl,
                        textAlign: TextAlign.right,
                        style: GoogleFonts.tajawal(color: Colors.black),
                      ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Text(
                        "الدخول إلي صالات كبار الزوار بأكثر من (25) مطار في مختلف دول العالم وللتعرف علي المزيد من المعلومات يقوم العميل بزيارة الموقع الالكتروني www.loungekey.com/visaplatinummena",
                        textDirection: TextDirection.rtl,
                        textAlign: TextAlign.right,
                        style: GoogleFonts.tajawal(color: Colors.black),
                      ),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Text(
                        "التمتع بالعديد من المزايا والخدمات أثناء السفر والتي تشمل خدمات طبية وقانونية. بالإضافة إلي خدمات أخري علي مستوي العالم.",
                        textDirection: TextDirection.rtl,
                        textAlign: TextAlign.right,
                        style: GoogleFonts.tajawal(color: Colors.black),
                      ),
              ...
              Container(
                ...
                child: Table(
                  ...
                  children: [
                    TableRow(children: [
                      Center(child: Text(' 400 جم  ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                        color: ArgonColors.warning,
                    ...
                    TableRow(children: [
                      Center(child: Text(' 300 جم  ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
                    ...
                    TableRow(children: [
                      Center(child: Text(' 4 بطاقات  ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
