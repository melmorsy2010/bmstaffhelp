...
class proddurabel extends StatefulWidget {


  @override

  _proddurabelState createState() => _proddurabelState();
}

class _proddurabelState extends State<proddurabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "اصحاب المهن والاعمال الحره",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            child: Center(child: Text("48",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("100000",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("عامان",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 10),
                          child: Container(
                            child: Center(child: Text("الحد الادنى لمده مزاوله النشاط",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 245,
                            height: 50,
                            decoration: BoxDecoration(
                              color: Colors.black,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 0,),
                          child: Container(
                            child: Center(child: Text(" 18.50",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3003",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "صوره البطاقه الضريبيه + صوره مستخرج رسمى حديث من السجل التجارى لم يمر عليه اكثر من 3 اشهر + مستند اثبات الدخل  + شهاده احكام تجاريه ( افلاس وبرتستو ) للشركاء والسمه التجاريه + صوره من تصريح مزاوله المهنه لاصحاب المهن الحره + صوره من عقد تاسيس الشركه لتحديد نصيب الشريك ( فى حاله وجود شركاء ) ",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "شيكات وفقا للاليه المعتمده + خطاب مطابقه توقيع العميل على الشيكات",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
