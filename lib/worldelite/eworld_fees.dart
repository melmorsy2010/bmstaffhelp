...
class Eworldfees extends StatelessWidget {
  @override
          ...
          children: [
            ...
            TableRow(children: [
              ...
              Padding(
                ...
                child: Text('2% شهريا',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black,fontSize: 13,fontWeight: FontWeight.bold),),
              ),
            ]),
            TableRow(children: [
              Padding(
