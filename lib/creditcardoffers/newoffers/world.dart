...
Future<void> generateAndPrintArabicPdf4({String details,String bookNum,String replay,String date,String subject,List<String>items, List<String> itemss, List<String> itemsss, List<String> itemsss4, List<String> itemsss5,List<String> itemsss6, List<String> itemsss7, List<String> itemsss8, String details2, String details3, List<String> itemsss9,}) async {
  ...
  final profileImage = MemoryImage(
    (await rootBundle.load('assets/we.jpg')).buffer.asUint8List(),
  );
                      ...
                      Row(
                          ...
                          children: [
                            Directionality(
                                textDirection: TextDirection.rtl,
                                child: Center(
                                    child: Text('ماستر كارد وورلد', style: TextStyle(
                                        fontSize: 17
                                    ))
                                )
                            ),
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('  واحد جنيه =   نقطة  3', style: TextStyle(
                                    fontSize: 17
                                ))
                            )
                        ),
  ...
  await Printing.sharePdf(bytes: await pdf.save(), filename: 'World.pdf');
