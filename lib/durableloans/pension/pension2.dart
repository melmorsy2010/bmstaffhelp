...
class pension2durabel extends StatefulWidget {


  @override

  _pension2durabelState createState() => _pension2durabelState();
}

class _pension2durabelState extends State<pension2durabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "اصحاب المعاش ( بدون بتعهد جهه المعاش )",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            child: Center(child: Text("84",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3002",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
