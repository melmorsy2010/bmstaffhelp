...
class tahoddurabel extends StatefulWidget {


  @override

  _tahoddurabelState createState() => _tahoddurabelState();
}

class _tahoddurabelState extends State<tahoddurabel> {
                      ...
                      child: Column(
                        children: [
                          Container(
                            child: Center(
                                child: Text(
                                    "بتعهد جهة العمل بتحويل المرتب أو القسط ق.ع",textAlign: TextAlign.center,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(right: 0,),
                            child: Container(
                              child: Center(child: Text(" 15.25",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                              width: 94,
                              height: 60,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(0),
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(right: 0),
                            child: Container(
                              child: Center(child: Text("3004",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                              width: 94,
                              height: 60,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(0),
