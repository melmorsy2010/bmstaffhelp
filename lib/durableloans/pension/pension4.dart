...
class pension4durabel extends StatefulWidget {


  @override

  _pension4durabelState createState() => _pension4durabelState();
}

class _pension4durabelState extends State<pension4durabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "مستفيدى المعاش ( بدون بتعهد جهه المعاش )",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            child: Center(child: Text("60",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("75000",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("يتم التامين ضد مخاطر الوفاه + مخاطر عدم السداد",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12 ),)),
                            width: 240,
                            height: 50,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 10),
                          child: Container(
                            child: Center(child: Text("رسوم التأمين",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 100,
                            height: 50,
                            decoration: BoxDecoration(
                              color: Colors.black,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("500",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 10),
                          child: Container(
                            child: Center(child: Text("الحد الادنى لصافى المعاش   ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 245,
                            height: 50,
                            decoration: BoxDecoration(
                              color: Colors.black,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("80 %",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text(" 65",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 50,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 10),
                          child: Container(
                            child: Center(child: Text("الحد الاقصي لسن المقترض ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14 ),)),
                            width: 245,
                            height: 50,
                            decoration: BoxDecoration(
                              color: Colors.black,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("% 1.5 ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 0,),
                          child: Container(
                            child: Center(child: Text(" 15.50",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3007",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "عرض اسعار على ان يكون المورد مكود بالبنك",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "بيان معتمد من جهة صرف المعاش يوضح قيمة المعاش وصفة العميل (صاحب معاش / مستحق معاش) رفق بيان بالمستفيدين في حالة مستحقي المعاشات",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "إقرار من العميل بعدم قطع تحويل المعاش على البنك طوال فترة التمويل",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "شيكات وفقا للاليه المعتمده لاستيفاء الشيكات + خطاب مطابقه توقيع العميل على الشيكات ",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "خطاب / كشف حساب يفيد تحويل المعاش الشهري",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
