...
class Customeroffer2 extends StatefulWidget {
  @override
  _Customeroffer2State createState() => _Customeroffer2State();
}

class _Customeroffer2State extends State<Customeroffer2> {
              ...
              Column(
                  children: <Widget>[
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 50,),
                          Container(child: Text("CLOSING CD",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),),
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(child: Text("المعادله محسوبه على شهادات 12 و 11 % فقط",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),),
                    ),
                    Row(
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                            child: Center(child: Text("%مبلغ القرض المتوقع 12 ",style: TextStyle(color: Colors.white),)),
                            color: Colors.blue,
                            height: 50,
                            width: 180,
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: Center(child: Text("%مبلغ القرض المتوقع 11",style: TextStyle(color: Colors.white),)),
                          color: Colors.blue,
                          height: 50,
                          width: 180,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Flexible(
                        ...
                        child: Container(
                          child: Center(child: Text(_maksb,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),)),
                          color: Colors.white,
                          height: 50,
                          width: 100,
