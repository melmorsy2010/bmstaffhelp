...
class mhnhora extends StatefulWidget {
  @override
  _mhnhoraState createState() => _mhnhoraState();
}

class _mhnhoraState extends State<mhnhora>
                          ...
                          children: <Widget>[
                            ...
                            AnimatedOpacity(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Container(
                                      child: Center(child: Text("أصحاب المهن الحره",style: GoogleFonts.cairo(color: Colors.white,fontSize: 13,fontWeight: FontWeight.bold,),textAlign: TextAlign.center,)),
                                      height: 50,
                                      width: 250,
                                      decoration: BoxDecoration(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(right: 0,),
                                child: Container(
                                  child: Center(child: Text(" 16.50",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                                  width: 94,
                                  height: 60,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(0),
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0),
                                child: Container(
                                  child: Center(child: Text("3028",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 13 ),textDirection: TextDirection.rtl)),
                                  width: 94,
                                  height: 60,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(0),
                          ...
                          Row(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0),
                                child: Container(
                                  child: Center(child: Text("85 %",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                                  width: 94,
                                  height: 50,
                                  decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(0),
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "صورة تصريح مزاولة المهنة ( في حالة أصحاب المهن الحرة ) ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "صورة مستخرج رسمي حديث من السجل التجاري او الصناعي (اخر 3 شهور) ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "كشف حساب بنكي أو بريد لمدة 6 شهور معتمد من جهة الاصدار أو  شهادة معتمدة من أحد المحاسبين القانونيين المعتمدين بالبنك المركزي أو جمعية الحاسبين والمراجعين المصرية أو شهادة من الضرائب لأخر سنة ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "استيفاء شهادة أحكام تجارية افلاس / بروتستو  ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
                                  ...
                                  Container(
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          child: Text(
                                            "صورة من أخر تعديل لعقد تأسيس الشركة ( في حالة أصحاب الاعمال الحرة ) ",
                                            textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                          ),
                                        )
                                      ],
