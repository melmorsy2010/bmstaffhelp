...
class pension3durabel extends StatefulWidget {


  @override

  _pension3durabelState createState() => _pension3durabelState();
}

class _pension3durabelState extends State<pension3durabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "مستفيدى المعاش ( بتعهد جهه المعاش )",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 0,),
                          child: Container(
                            child: Center(child: Text(" 15",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3006",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "تعهد هيئة التأمينات والمعاشات أو الجهة المنوط بها تحويل المعاش",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
