...
class tahod4 extends StatefulWidget {
  @override
  _tahod4State createState() => _tahod4State();
}

class _tahod4State extends State<tahod4> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "جهات متعاقده \n تعهد جهه العمل بتحويل الراتب او القسط والمستحقات بالعاملين بالدوله ( تحويل قسط فقط )",textAlign: TextAlign.center,
