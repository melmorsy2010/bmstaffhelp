...
class _CashState extends State<Cash> with SingleTickerProviderStateMixin {
  ...
  String dropdownvalue = '1- تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات متعاقده';
  var items = [
    '1- تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات متعاقده',
    '2- تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات غير متعاقده',
    '3- تعهد جهه العمل تحويل الراتب / القسط فقط',

  ];
  String dropdownvalue3 = ' 1- تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات متعاقده';
  var items3 = [
    ' 1- تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات متعاقده',
    '2- تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات غير متعاقده',
    '3- تعهد جهه العمل بتحويل الراتب / القسط فقط ',
  ];
...
double r2 = 14;
      ...
      heba5 = (heba4 /heba);
      heba6= (n3*heba5) ;
      hebaa2 = heba6.toStringAsFixed(2) ;
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text("أختر القطاع التابع له  ",
              ...
              if (dropdownvalue2.contains("حكومي")) ...{
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Container(
              ...
              } else if (dropdownvalue2.contains("خاص")) ...{
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Container(
  ...
  Widget emiResultsWidget(emiResult) {
        ...
        Container(
          child: canShow
              ? Column(children: [
                  ...
                  if (int.parse(duryr3.toString()) > 120 &&
                  ...
                  } else if (int.parse(duryr3.toString()) < 120 &&
            ...
            if (int.parse(duryr3.toString()) > 120 &&
              ...
              children: [
                ...
                int.parse(dd.toString()) > 252&& dropdownvalue.contains("تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات غير متعاقده"))...{ Row(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Padding(
    ...
    if (dropdownvalue.contains("تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات متعاقده"))...{
    Row(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                                  ...
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: Center(
                                              child: Text(
                                                "مده القرض المدخله  اكبر من المتاحه $yearrs2 سنوات ",
                                                textAlign: TextAlign.center,
                                              )),
                                        );
                                      });
                                  ...
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: Center(
                                              child: Text(
                                                "أقل مده للقرض 6 أشهر",
                                                textAlign: TextAlign.center,
                                              )),
                                        );
                                      });
                                }
                                else if (dropdownvalue.contains("تعهد جهه العمل تحويل الراتب / القسط والمستحقات جهات متعاقده") &&
                                    int.parse(_principalAmount.text) >1500000
                                ) {
                                  showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: Center(
                                              child: Text(
                                                "الحد الاقصى للقرض  1500000 جم للجهات المتعاقده ",
                                                textAlign: TextAlign.center,
                                              )),
                                        );
                                      });
                                  ...
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title: Center(
                                              child: Text(
                                                "الحد الاقصى للقرض  1000000 جم للجهات  غير المتعاقده ",
                                                textAlign: TextAlign.center,
                                              )),
                                        );
                                      });
                                    ...
                                    int.parse(_principalAmount.text) <5000
                                ) {
                                  showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
            ...
            children: [
              RaisedButton(
                ...
                onPressed: (){
                  ...
                  return generateAndPrintArabicPdfemployee(

                    details:dropdownvalue2,details2:dropdownvalue,details3:_value.year.toString() +"/"+ _value.month.toString() +"/"+_value.day.toString(),bookNum: duryr,replay: _income.text,date: aksaakest,subject: _clientname.text,mobile: _mobilenumb.text,principle: _principalAmount.text,tenuree: _tenure.text,kest: _emiResult,qr: _staffname.text,
                    items:[ if (int.parse(duryr3.toString()) > 120 &&
                        int.parse(dd.toString()) > 252)...{aksaa }else if (int.parse(duryr3.toString()) < 120 &&
    int.parse(duryr3.toString()) > 0 &&
    int.parse(dd.toString()) > 252) ...{duryr3} ],

                    itemss:[ if (int.parse(duryr3.toString()) > 120 &&
                        int.parse(dd.toString()) > 252)...{hebaa }else if (int.parse(duryr3.toString()) < 120 &&
                        int.parse(duryr3.toString()) > 0 &&
                   ...
                   itemsss13:[ if (int.parse(duryr3.toString()) < items.toString().length )...{"%$nazmyyfixed" ,_installment,nazmyy,"$duryr3 شهر  - أقصى مده "}],
                    ...
                    itemsss100:[ _adminfeess + " جم " ,"المصاريف الاداريه 3% "],
