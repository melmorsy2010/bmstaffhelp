...
class tahod3 extends StatefulWidget {
  @override
  _tahod3State createState() => _tahod3State();
}

class _tahod3State extends State<tahod3> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "جهات متعاقده \n تعهد جهه العمل بتحويل الراتب او القسط والمستحقات بالعاملين بالدوله ( تحويل راتب بالكامل )",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("1500000",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(right: 0,),
                          child: Container(
                            child: Center(child: Text(" 13.75",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3863",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                            ...
                            Container(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "سند لامر + تفويض بملئ السند لأمر",
                                      textAlign: TextAlign.right,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),
                                    ),
                                  )
                                ],
