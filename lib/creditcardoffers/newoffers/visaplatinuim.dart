                      ...
                      Row(
                          ...
                          children: [
                            Directionality(
                                textDirection: TextDirection.rtl,
                                child: Center(
                                    child: Text('فيزا بلاتينيوم', style: TextStyle(
                                        fontSize: 17
                                    ))
                                )
                            ),
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('عروض وتخفيضات في أرقي المراكز التجارية داخل وخارج مصر وللتعرف عليها  يقوم العميل \n بالدخول علي الموقع الالكتروني  www.visamidleeeast.com/visaplatinum  أو منخلال التطبيق\n  الخاص بمؤسسة فيزا الدولية والذي يتم تحميله من علي التليفون المحمول VISA EXPLORE ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('حماية المشتريات: حيث تقدم تلك الخدمة لحاملي البطاقات البلاتينية لحماية مشترياتهم ضد\n السرقة والتلف لمدة 365 يوم من تاريخ الشراء. ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('الدخول إلي صالات كبار الزوار بأكثر من (25) مطار في مختلف دول العالموللتعرف علي المزيد \n من المعلومات يقوم العميل بزيارة الموقع الالكتروني\n www.loungekey.com/visaplatinummena ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('التمتع بالعديد من المزايا والخدمات أثناء السفر والتي تشمل خدمات طبية وقانونية\n. بالإضافة إلي خدمات أخري علي مستوي العالم ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('  واحد جنيه =   نقطة  2.5', style: TextStyle(
                                    fontSize: 17
                                ))
                            )
                        ),
