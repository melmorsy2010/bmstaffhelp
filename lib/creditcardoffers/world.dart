            ...
            child: canShow ?Column(children: [
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      "الحصول علي كثير من العروض والتخفيضات من خلال التطبيق Master Card for you وكذلك التطبيق Master Card Buy 1 Get 1 الذي يتم تحميله من علي التليفونات المحمولة",
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: GoogleFonts.tajawal(color: Colors.black),
                    ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      "دخول مجاني غير محدود لأكثر من 900 صالة لاونج كي في جميع انحاء العالم، للمزيد من المعلومات عن صالات كبار الزوار بمختلف المطارات يرجي زيارة www.loungekey.com/mcworld.",
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: GoogleFonts.tajawal(color: Colors.black),
                    ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      "توفر المنظمة الدولية مركز دعم فني متخصص علي مدار 24 ساعة يوميا لتقديم العديد من الخدمات لحاملي البطاقة (Cardholder enquiries) بالإضافة إلي ما يقدمه مركز الاتصال الخاص ببنك مصر 19888 من خدمات.",
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: GoogleFonts.tajawal(color: Colors.black),
                    ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      "توفر المنظمة خدمة تأمينية عند السفر مثل (ضياع الحقائب – تأخر وصول الحقائب – إلغاء الرحلة – التأمين الطبي أثناء السفر ... إلخ).",
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: GoogleFonts.tajawal(color: Colors.black),
                    ),
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      "توفر المنظمة الدولية موقع خاص بحاملي تلك البطاقة علي شبكة الانترنت يتضمن كافة التفاصيل والخدمات والعروض المتاحة للبطاقات علي مستوي العالمhttps://www.mastercard.com.eg/ar-eg/consumers/find-card-products/world.html.",
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: GoogleFonts.tajawal(color: Colors.black),
                    ),
              ...
              Container(
                ...
                child: Table(
                  ...
                  children: [
                    TableRow(children: [
                      Center(child: Text(' 1500 جم  ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
                    ...
                    TableRow(children: [
                      Center(child: Text(' بدون حد اقصى ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                ...
                                image: AssetImage('assets/wmzaya.png'),),
