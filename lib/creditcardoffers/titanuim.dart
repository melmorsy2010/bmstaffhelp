...
//widgets
class Titanuiim extends StatefulWidget {
  @override
  _TitanuiimState createState() => _TitanuiimState();
}

class _TitanuiimState extends State<Titanuiim> {
            ...
            child: canShow ?Column(children: [
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: Text(
                      "توفير خدمة الدخول لصالات رجال الاعمال مجانا لحامل البطاقة لدي بعض المطارات المتعاقدة مع المنظمة في هذا الشأن.",
                      textDirection: TextDirection.rtl,
                      textAlign: TextAlign.right,
                      style: GoogleFonts.tajawal(color: Colors.black),
                    ),
              ...
              Container(
                ...
                child: Table(
                  ...
                  children: [
                    TableRow(children: [
                      Center(child: Text(' 250 جم  ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
                    ...
                    TableRow(children: [
                      Center(child: Text(' 150 جم  ',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
                    ...
                    TableRow(children: [
                      Center(child: Text(' 3 بطاقات',textDirection: TextDirection.rtl,style: TextStyle(color: Colors.black),)),
                      Container(
                          color: ArgonColors.warning,
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                ...
                                image: AssetImage('assets/titanums.png'),),
