                    ...
                    children: [
                          ...
                          children: [
                            Container(
                              ...
                              Directionality(
                                  textDirection: TextDirection.rtl,
                                  child: Center(
                                      child: Text(carprice+"جم", style: TextStyle(
                                        fontSize: 15,
                                      ),
                                      )
                                  )
                            ...
                            Container(
                              ...
                              Directionality(
                                  textDirection: TextDirection.rtl,
                                  child: Center(
                                      child: Text(' سعر السيارة ', style: TextStyle(
                                        fontSize: 15,
                                      ),
                                      )
                                  )
                            ...
                            Container(
                              ...
                              Directionality(
                                  textDirection: TextDirection.rtl,
                                  child: Center(
                                      child: Text(' نوع السيارة ', style: TextStyle(
                                        fontSize: 15,
                                      ),
                                      )
                                  )
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              Directionality(
                                  textDirection: TextDirection.rtl,
                                  child: Center(
                                      child: Text(' قيمه المقدم ', style: TextStyle(
                                        fontSize: 15,
                                      ),
                                      )
                                  )
                            ...
                            Container(
                              ...
                              Directionality(
                                  textDirection: TextDirection.rtl,
                                  child: Center(
                                      child: Text(' قيمه القرض ', style: TextStyle(
                                        fontSize: 15,
                                      ),
                                      )
                                  )
                      ...
                      Center(
                        child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                             if(productt == '1 تعهد جهه العمل تحويل الراتب / القسط والمستحقات قطاع عام'||productt == '2 تعهد جهه العمل تحويل الراتب / القسط والمستحقات قطاع عام(مستعمل)')...{ Container(
                                // width: 100,
                                height: 100,
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('عرض أسعار من المعرض  فيما عدا السيارات المستعمله - بالنسبه للسيارات المستعلمله \n يتم استيفاء عقد بيع ابتدائى وصوره بطاقه البائع وصوره رخصه السياره ساريه ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('يمكن منح العميل قرض لشراء سياره مستعمله على الا يتعدى موديل صنع السياره اكثر من 3 اعوام', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
                  ...
                  Row(
                      ...
                      children: [
                        Directionality(
                            textDirection: TextDirection.rtl,
                            child: Center(
                                child: Text('لا يتم السداد المعحل الكلى للقرض الا بعد مرور سنه من عمر القرض ', style: TextStyle(
                                  fontSize: 15,
                                ),
                                )
                            )
