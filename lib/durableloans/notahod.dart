...
class tahod3durabel extends StatefulWidget {


  @override

  _tahod3durabelState createState() => _tahod3durabelState();
}

class _tahod3durabelState extends State<tahod3durabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "تحويل الراتب/القسط ق.ع (بدون تعهد تحويل الراتب للعاملين بالجهات المتعاقدة)",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3040",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
