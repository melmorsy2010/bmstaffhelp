...
class pensiondurabel extends StatefulWidget {


  @override

  _pensiondurabelState createState() => _pensiondurabelState();
}

class _pensiondurabelState extends State<pensiondurabel> {
                    ...
                    child: Column(
                      children: [
                        Container(
                          child: Center(
                            child: Text(
                              "اصحاب المعاش ( بتعهد جهه المعاش )",textAlign: TextAlign.center,
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("يتم التامين ضد مخاطر الوفاه فقط",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 240,
                            height: 50,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: Container(
                            child: Center(child: Text("3005",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17 ),)),
                            width: 94,
                            height: 60,
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(0),
